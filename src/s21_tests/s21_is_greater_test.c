...
START_TEST(test_s21_is_greater_18) {
    s21_decimal num1 = {{0xA, 0x0, 0x0, 0x001C0000}};   // 0.0000000000000000000000000001
...
START_TEST(test_s21_is_greater_20) {
    s21_decimal num1 = {{0xC8340001, 0x8881186E, 0x4A03CE6, 0x120000}}; //  // 1431655765.000000000000000001

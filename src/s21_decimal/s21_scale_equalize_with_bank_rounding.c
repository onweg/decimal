...
void s21_scale_equalize_with_bank_rounding(s21_decimal *value1,
                                           s21_decimal *value2) {
  ...
  if (exp1 > exp2) {
    int flag = 0;
    while (flag == 0 && s21_get_exp(*value2) < 28 &&
           s21_get_exp(*value2) < s21_get_exp(*value1)) {
      flag = s21_scale_increase(value2, 1);
    }
    if (s21_get_exp(*value1) > s21_get_exp(*value2)) {
      s21_scale_decrease(value1,
                         s21_get_exp(*value1) - s21_get_exp(*value2) - 1);
      int num1 = 0;
      s21_decimal tmp = {0};
    ...
    int flag = 0;
    while (flag == 0 && s21_get_exp(*value1) < 28 &&
           s21_get_exp(*value1) < s21_get_exp(*value2)) {
      flag = s21_scale_increase(value1, 1);
    }
    if (s21_get_exp(*value1) < s21_get_exp(*value2)) {
      s21_scale_decrease(value2,
                         s21_get_exp(*value2) - s21_get_exp(*value1) - 1);
      int num1 = 0;
      s21_decimal tmp = {0};
